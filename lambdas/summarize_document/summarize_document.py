...
def lambda_handler(event, context):
    ...
    """
    # LLM mode: "local" or "remote" (from AWS Parameter Store via env var)
    ...
    for record in event.get('Records', []):
        ...
        try:
            ...
            # TODO: Add actual document processing logic here (use llm_mode: local vs remote)
            # - Extract text from document
            # - Generate summary using AI/ML service (local or remote based on LLM_MODE)

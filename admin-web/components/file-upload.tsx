...
import { uploadFile, uploadJsonFile, ApiError } from "@/lib/api"
  ...
  const handleUpload = useCallback(async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `File ${result.filename} uploaded to ${result.key}`,
      })
      
      setUploadProgress(`Success! File uploaded to ${result.key}`)
      setFile(null)
      setFolder("")
